...
def create_month_sheet(workbook, month, year):
    ...
    #    k = col + list(attendance_dict.keys()).index(K) + 1
    #    sheet.cell(row=15, column=k).value = V
...
def add_summary_and_chart(workbook, workers, total_days_dict):
    for sheet in workbook.worksheets:
        ...
        dict_day = {
            23: {"P": 'Z', "L": 'AA', "E": 'AB', "U": 'AC', "N": 'AD'},
            22: {"P": 'Y', "L": 'Z', "E": 'AA', "U": 'AB', "N": 'AC'},
            21: {"P": 'X', "L": 'Y', "E": 'Z', "U": 'AA', "N": 'AB'},
            20: {"P": 'W', "L": 'X', "E": 'Y', "U": 'Z', "N": 'AA'}
        }
        ...
        # Add the data validation to a specific range (e.g., A1 to C1)
        sheet.add_data_validation(dv)
...
def main():
    ...
    workers = ['Ashani Akatugba', 'Basey Nton N,', 'Anointing Obiora', 'Denis Esikpong',
               ...
               'Ofonime Emmanuel', 'Blessing Edet', 'Victor Emordi', 'Chris Okoh', 'Christopher Monday']
